...
```
### 20.编写socket套接字的步骤.
[https://blog.csdn.net/zhubo22/article/details/8045537](编写socket套接字的步骤)

### 21.TCP三次握手和四次挥手, 以及各个状态的作用
[https://blog.csdn.net/sinat_32487221/article/details/55272305](TCP的三次握手与四次挥手过程，各个状态名称与含义，TIMEWAIT的作用)
